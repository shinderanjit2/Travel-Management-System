		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmPackage4.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
...
//		Bill();
	...
	public void Connect()
	{
		...
		{
			JOptionPane.showMessageDialog(frmPackage4, e, "DATABASE WARNING",1);
			//System.out.print(e);
		}
		catch(SQLException e1)
		{
			JOptionPane.showMessageDialog(frmPackage4, e1, "DATABASE WARNING",2);
			//System.out.print(e1);
		}
	}
	...
	*/
	...
	private void initialize() {
		frmPackage4 = new JFrame();
		frmPackage4.setTitle("PACKAGE4");
		...
		//frmPackage4.setResizable(false);
		
		frmPackage4.setSize(screenSize.width,height);
		//frmPackage4.setLocationRelativeTo(null);
		frmPackage4.setExtendedState(JFrame.MAXIMIZED_BOTH);
		
		//frmPackage4.setBounds(100, 100, 1428, 784);
		frmPackage4.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmPackage4.getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBackground(new Color(0, 204, 0));
		panel.setBounds(36, 10, 1450, 125);
		frmPackage4.getContentPane().add(panel);
		...
		frmPackage4.getContentPane().add(panel_4);
		...
		JLabel lblDestination = new JLabel("KOLHAPUR");
		...
		frmPackage4.getContentPane().add(panel_4_1);
		...
		frmPackage4.getContentPane().add(panel_1);
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=1;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 1 Is Selected", "Seat Booking", 1);
		...
		b4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=4;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 4 Is Selected", "Seat Booking", 1);
		...
		b7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=7;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 7 Is Selected", "Seat Booking", 1);
		...
		b2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=2;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 2 Is Selected", "Seat Booking", 1);
		...
		b5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=5;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 5 Is Selected", "Seat Booking", 1);
		...
		b8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=8;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 8 Is Selected", "Seat Booking", 1);
		...
		b3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=3;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 3 Is Selected", "Seat Booking", 1);
		...
		b6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=6;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 6 Is Selected", "Seat Booking", 1);
		...
		b9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=9;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 9 Is Selected", "Seat Booking", 1);
		...
		b10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=10;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 10 Is Selected", "Seat Booking", 1);
		...
		b11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=11;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 11 Is Selected", "Seat Booking", 1);
		...
		b12.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=12;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 12 Is Selected", "Seat Booking", 1);
		...
		b13.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=13;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 13 Is Selected", "Seat Booking", 1);
		...
		b14.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=14;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 14 Is Selected", "Seat Booking", 1);
		...
		b15.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=15;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 15 Is Selected", "Seat Booking", 1);
		...
		b16.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=16;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 16 Is Selected", "Seat Booking", 1);
		...
		b17.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=17;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 17 Is Selected", "Seat Booking", 1);
		...
		b18.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=18;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 18 Is Selected", "Seat Booking", 1);
		...
		b19.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=19;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 19 Is Selected", "Seat Booking", 1);
		...
		b20.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=20;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 20 Is Selected", "Seat Booking", 1);
		...
		b21.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=21;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 21 Is Selected", "Seat Booking", 1);
		...
		b22.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=22;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 22 Is Selected", "Seat Booking", 1);
		...
		b23.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=23;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 23 Is Selected", "Seat Booking", 1);
		...
		b24.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=24;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 24 Is Selected", "Seat Booking", 1);
		...
		b25.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=25;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 25 Is Selected", "Seat Booking", 1);
		...
		b26.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=26;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 26 Is Selected", "Seat Booking", 1);
		...
		b27.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=27;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 27 Is Selected", "Seat Booking", 1);
		...
		b28.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=28;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 28 Is Selected", "Seat Booking", 1);
		...
		b29.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=29;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 29 Is Selected", "Seat Booking", 1);
		...
		b30.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=30;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 30 Is Selected", "Seat Booking", 1);
		...
		b31.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=31;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 31 Is Selected", "Seat Booking", 1);
		...
		b32.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=32;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 32 Is Selected", "Seat Booking", 1);
		...
		b33.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=33;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 33 Is Selected", "Seat Booking", 1);
		...
		b34.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=34;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 34 Is Selected", "Seat Booking", 1);
		...
		b35.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=35;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 35 Is Selected", "Seat Booking", 1);
		...
		b36.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=36;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 36 Is Selected", "Seat Booking", 1);
		...
		b37.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=37;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 37 Is Selected", "Seat Booking", 1);
		...
		b38.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=38;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 38 Is Selected", "Seat Booking", 1);
		...
		b39.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=39;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 39 Is Selected", "Seat Booking", 1);
		...
		b40.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=40;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 40 Is Selected", "Seat Booking", 1);
		...
		b41.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=41;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 41 Is Selected", "Seat Booking", 1);
		...
		b42.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seatno=42;
				JOptionPane.showMessageDialog(frmPackage4, "Seat 42 Is Selected", "Seat Booking", 1);
		...
		frmPackage4.getContentPane().add(txtDate);
		...
		frmPackage4.getContentPane().add(panel_3);
		...
		frmPackage4.getContentPane().add(txtBill);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(rs.next()==true)
					{
						JOptionPane.showMessageDialog(frmPackage4, "Seat "+seat+" Is Already Booked On "+date+"\n Please Select The Another Seat..!!", "Seat full", 2);
					}
					else if(name.equals(""))
					{
						JOptionPane.showMessageDialog(frmPackage4, "Please Enter Your Name..!!","Name",2);
					}
					else if(seatno==0)
					{
						JOptionPane.showMessageDialog(frmPackage4, "Please Select The Seat..!!","Seat",2);
					}
					else if(date==null)
					{
						JOptionPane.showMessageDialog(frmPackage4, "Please Select The Date..!!","Date",2);
					}
					...
					else
					{
						...
						if(k==1)
						{
							JOptionPane.showMessageDialog(frmPackage4, "SEAT BOOKED SUCCESSFULLY..!!","Successfull",1);
						...
						{
							JOptionPane.showMessageDialog(frmPackage4, "Somthing Went Wrong..!!","Errorr",2);
						}
		...
		frmPackage4.getContentPane().add(btnNewButton);
		
		JButton btnBack = new JButton("BACK");
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Homepage.main(null);
				frmPackage4.setVisible(false);
			}
		});
		...
		frmPackage4.getContentPane().add(btnBack);
